...
import { ArrowRight, GraduationCap, Mail, Calendar, Clock, MapPin as MapPinIcon, User, Menu, X, Shield } from "lucide-react"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#ffe8e4]">
      <div className="fixed left-0 top-0 z-40 w-full bg-[#1e2a5a]/85 px-4 py-3 backdrop-blur-sm sm:px-6 lg:px-8">
