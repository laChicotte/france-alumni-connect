        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-4 flex items-center gap-4">
            <div className="flex w-full flex-wrap items-center gap-3">
                ...
                <Link
                  href="/entrepreneurs"
                  className="inline-flex h-10 items-center gap-2 rounded-full bg-[#FF0000] px-5 text-sm font-semibold text-white hover:bg-[#2a4580] transition-colors shrink-0 ml-auto"
                >
                  <Building2 className="h-4 w-4" />
                  Entreprises fondées par nos Alumni
                </Link>
            </div>
          </div>
        </div>
